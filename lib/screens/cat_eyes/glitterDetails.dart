...
class GlitterDetails extends StatelessWidget {
  final isTablet = TabletDetector.isTablet(MediaQueryData.fromWindow(WidgetsBinding.instance.window));
  GlitterDetails({super.key, required this.nail, required this.nails});
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        const BottleShadow(),
                        Image.asset(
                          "assets/bottle/glitter_bottle.png",
                          width: 275.w,
                          // height: 594.h,
                        ),
                      ],
