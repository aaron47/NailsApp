...
class HolographieDetails extends StatelessWidget {
  final isTablet = TabletDetector.isTablet(MediaQueryData.fromWindow(WidgetsBinding.instance.window));
  HolographieDetails({super.key, required this.nail, required this.nails});
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        const BottleShadow(),
                        Image.asset(
                          "assets/bottle/holographique_bottle.png",
                          width: 275.w,
                          // height: 594.h,
                        ),
                      ],
